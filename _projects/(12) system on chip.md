...
<p>
The goal of this project was <b>to build a system to automate SoC/IP regression workflow</b>. It standardized and improved individual verification engineers' workflow and finally reduced TAT time before tape-out. <br/>
<br/>
My role was <b>to develop user interface and a server</b> for SoC/IP regression automation. User interface includes both Command Line Interface (CLI) and Graphical User Interface (GUI) They were developed with <b>Perl/Python</b> and <b>Vue.js/Electron</b> respectively. <b>Django and Django REST Framework</b> were used to develop a backend server, and <b>Gunicorn + Nginx</b> were used to deploy a server as a service.
</p>
<p>
